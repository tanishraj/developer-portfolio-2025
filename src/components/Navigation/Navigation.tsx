  ...
  return (
    <motion.nav
      ...
      className={`fixed w-full z-50 transition-all duration-300 ${
        scrolled
          ? 'bg-[#0a0f1b]/90 backdrop-blur-md py-4 border-b border-gray-800'
          : 'bg-transparent py-6'
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 xl:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden xl:flex items-center gap-4">
            <a href="https://github.com/tanishraj" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
            ...
            <a href="https://www.linkedin.com/in/itsmetanishraj/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
